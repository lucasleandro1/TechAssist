module MobileDeviceManager
  class Updater
    ...
    def call
      ...
      response_error( message: I18n.t("activerecord.errors.messages.device_notfound #{e.message}"))
    ...
    def response(data)
      { success: true, message: I18n.t("activerecord.messages.device_updated"), resources: data }
    end
